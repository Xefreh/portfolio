document.addEventListener("DOMContentLoaded", function () {
  ...
  const burger_menu_image = document.querySelector(".burger-menu img");
  const burger_menu_list = document.querySelector(".burger-menu ul");
  const carousel_container = document.querySelector(".carousel-container");

  function showMenu() {
    burger_menu_list.classList.toggle("active2");
    burger_menu_list.classList.toggle("disable");
    carousel_container.classList.toggle("carousel-active");

    if (burger_menu_image.getAttribute("src") === "imgs/menu.svg") {
      burger_menu_image.setAttribute("src", "imgs/close.svg");
    } else {
      burger_menu_image.setAttribute("src", "imgs/menu.svg");
    }
  }

  burger_menu_image.addEventListener("click", showMenu);
